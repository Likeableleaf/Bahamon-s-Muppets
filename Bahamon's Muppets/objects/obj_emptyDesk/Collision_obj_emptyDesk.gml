...
if(calcId.id != id)
{
    ...
    var dir = point_direction(other.x, other.y, x, y); // calculate the direction from the other desk to this desk
    ...
    var overlap = (sprite_width + other.sprite_width) / 2 - distance;
