...
draw_text_color(x+700, y+200, "Detention Royale", c_purple,c_fuchsia,c_white,c_blue,1);

draw_set_font(CountdownFont2);

draw_text_color(x+400, y +600,"You are a student in Detention!", c_black,c_black,c_black,c_black,1);
draw_text_color(x+400, y +640,"You've heard how intense the Professor Dan is, and bet your", c_black,c_black,c_black,c_black,1);
draw_text_color(x+400, y +680,"friends you can last the longest! However, Prof. Dan says you're", c_black,c_black,c_black,c_black,1);
